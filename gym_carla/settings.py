...
MODEL_NUMBER = 29  # int|None. If int carla will try to load model, if none it will never even try!
MODEL_USE_TENSORBOARD_LOG = True  # Bool
MODEL_EXPORT_RATE = 20000000 if MODEL_RL_MODULE is "PPO2" else 200000000  # Callback steps (Dependent on n_episodes)
MODEL_N_STEPS = 256
MODEL_ACTION_TYPE = 1  # 0: Discrete, 1: MultiDiscrete, 2: Box
MODEL_ENT_COEF = 0.01  # Default: 0.01
MODEL_LEARNING_RATE = 0.00075  # Default: 0.00025, was 0.00075
MODEL_LEARNING_RATE_MIN = 0.0001
MODEL_MAX_EPISODES = 600
MODEL_CLIP_RANGE = 0.6
MODEL_CLIP_RANGE_MIN = 0.2
MODEL_NAME = "DefaultName"

TRANSFER_AGENT = 2  # 0: NONE, 1: WEIGHTS, 2: IMITATION
TRANSFER_POLLING_RATE_START = 0.75  # [1; 0]
