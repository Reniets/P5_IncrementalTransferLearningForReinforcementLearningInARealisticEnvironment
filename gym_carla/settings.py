...
CARLA_SIMS = [['localhost', 3000, 'Niveau3'], ['localhost', 3003, 'Curve_Wide'], ['localhost', 3006, 'Curve_Wide'], ['localhost', 3009, 'Curve_Wide'], ['localhost', 3012, 'Curve_Wide'], ['localhost', 3015, 'Curve_Wide']]  # Possible simulations that can be created in format [Host, port, mapname]
...
MODEL_LEARNING_RATE_MIN = 0.00075
