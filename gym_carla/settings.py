...
# CarlaEnv settings
CARLA_PATH = '/home/d506e19/carla/Dist/CARLA_Shipping_0.9.6-23-gc6624e4c-dirty/LinuxNoEditor'  # Path to Carla root folder
...
CARLA_TICKS_PER_EPISODE = 45 * (1 / AGENT_TIME_STEP_SIZE)  # Steps
...
MODEL_NAME = "PPO2_Reproduce_moreTimeSteps_MD_MorePenalty_turnSensi"
MODEL_NUMBER = 9  # int|None. If int carla will try to load model, if none it will never even try!
